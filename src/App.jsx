...
<div className=''>
     <Navbar bg="dark" variant='dark' expand="lg">
      <Container>
        <Navbar.Brand href="#home">LOKKI React Bootstrap</Navbar.Brand>
        ...
        <Badge className='add' bg="warning">
          <span>🛒</span> Cart <span className='count'>{count}</span>
        </Badge>
        </div>
      ...
      <marquee width="60%" direction="left" scrollamount="20" height="80px">
       <h1><i>📱📱 Buy now 📱📱</i></h1>
     </marquee>
      </div>
